...
/*
06.- Crear variable booleanoNot cuyo valor sea la comparación booleana no booleano1
*/
...
let contarHasta10=0;//se abre variable

while(contarHasta10<=10){//mientras la variable sea menor o igual a 10
...
for(i=0; i<11; i++){
    preI+=++preJ//sumar al valor de es lo de +=
}
